...
- **多平台搜索**：网易云 / QQ / 酷狗 / 百度 / 酷我 5 平台并发搜索，合并去重
- **播放 / 歌词 / 歌单 / 专辑**：完整媒体链路
- **榜单 & 推荐歌单**：内置网易云官方榜单 11 个（飙升 / 新歌 / 热歌 / 原创 / 说唱 / 古典 / 电音 / 摇滚 / 抖音 / 韩语 / ACG），并作为推荐歌单展示，免鉴权即可看榜（MetingAPI 无个性化推荐 feed，官方榜单即最稳妥的推荐来源）
...
> 不填 `apiBase` 也能**直接搜索 + 看榜 + 播放**（搜索走公共公益实例、播放 / 歌词 / 榜单走 injahow 兜底）。填了自建 Vercel 地址后更快、更全、更稳，且搜索/取链带 HMAC 鉴权更安全。
